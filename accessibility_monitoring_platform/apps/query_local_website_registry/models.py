...
class Organisation(models.Model):
    ...
    organisation_type = models.ForeignKey('OrganisationType', models.DO_NOTHING, blank=True, null=True)
...
class NutsConversion(models.Model):
    ...
    lau118nm = models.CharField(db_column='LAU118NM', max_length=200, blank=True, null=True)
    nuts318cd = models.CharField(db_column='NUTS318CD', max_length=200, blank=True, null=True)
    nuts318nm = models.CharField(db_column='NUTS318NM', max_length=200, blank=True)
    nuts218cd = models.CharField(db_column='NUTS218CD', max_length=200, blank=True, null=True)
    nuts218nm = models.CharField(db_column='NUTS218NM', max_length=200, blank=True, null=True)
    nuts118cd = models.CharField(db_column='NUTS118CD', max_length=200, blank=True, null=True)
    nuts118nm = models.CharField(db_column='NUTS118NM', max_length=200, blank=True, null=True)
