    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_type', models.CharField(choices=[('other', 'Other'), ('keyboard', 'Keyboard'), ('zoom', 'Zoom and Reflow'), ('audio-visual', 'Audio and Visual'), ('additional', 'Additional'), ('', ''), ('pdf', 'PDF')], default='other', max_length=20)),
