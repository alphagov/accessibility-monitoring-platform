# Generated by Django 4.2.4 on 2023-11-29 10:58
...
DEFAULT_CREATION_DATETIME = convert_date_to_datetime(date(1970, 1, 1))
    ...
    for audit in Audit.objects.all():
        ...
        if (
            ...
            if audit.audit_retest_accessibility_statement_backup_url_date:
                ...
                twelve_week_statement_page.created = DEFAULT_CREATION_DATETIME
