    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_type', models.CharField(choices=[('additional', 'Additional'), ('audio-visual', 'Audio and Visual'), ('keyboard', 'Keyboard'), ('other', 'Other'), ('pdf', 'PDF'), ('zoom', 'Zoom and Reflow')], default='other', max_length=20)),
