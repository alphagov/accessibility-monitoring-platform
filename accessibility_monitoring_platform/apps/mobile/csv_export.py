...
MOBILE_EQUALITY_BODY_METADATA_COLUMNS_FOR_EXPORT: list[
    ...
    EqualityBodyCSVColumn(
        ...
        source_classkey=MobileCase,
        source_attr="enforcement_body",
        required=True,
        edit_url_classkey=MobileCase,
...
MOBILE_CASE_COLUMNS_FOR_EXPORT: list[CSVColumn] = [
    # General
    CSVColumn(
        column_header="Case no.", source_classkey=MobileCase, source_attr="case_number"
    ),
    CSVColumn(
        column_header="Version", source_classkey=MobileCase, source_attr="version"
    ),
    CSVColumn(
    ...
    CSVColumn(
        column_header="Date created", source_classkey=MobileCase, source_attr="created"
    ),
    CSVColumn(column_header="Status", source_classkey=MobileCase, source_attr="status"),
    CSVColumn(
        column_header="Domain name", source_classkey=MobileCase, source_attr="domain"
    ),
    CSVColumn(
    ...
    CSVColumn(column_header="Sector", source_classkey=MobileCase, source_attr="sector"),
    CSVColumn(
        column_header="Sub-category",
        source_classkey=MobileCase,
        source_attr="subcategory",
    ...
    CSVColumn(
        column_header="Contact name", source_classkey=MobileContact, source_attr="name"
    ),
    CSVColumn(
        column_header="Contact job title",
        source_classkey=MobileContact,
