...
def test_case_qa_status_unassigned_qa_case():
    ...
    assert case.qa_status == SimplifiedCase.QAStatus.UNASSIGNED
...
def test_case_qa_status_in_qa():
    ...
    assert case.qa_status == SimplifiedCase.QAStatus.IN_QA
...
def test_case_qa_status_qa_approved():
    ...
    assert case.qa_status == SimplifiedCase.QAStatus.APPROVED
