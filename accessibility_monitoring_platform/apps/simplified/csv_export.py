...
SIMPLIFIED_EQUALITY_BODY_METADATA_COLUMNS_FOR_EXPORT: list[EqualityBodyCSVColumn] = [
    EqualityBodyCSVColumn(
        ...
        required=True,
        edit_url_classkey=SimplifiedCase,
...
SIMPLIFIED_CASE_COLUMNS_FOR_EXPORT: list[CSVColumn] = [
    CSVColumn(
        column_header="Case no.",
        source_classkey=SimplifiedCase,
        source_attr="case_number",
    ),
    CSVColumn(
        column_header="Version", source_classkey=SimplifiedCase, source_attr="version"
    ),
    CSVColumn(
    ...
    CSVColumn(
        column_header="Date created",
        source_classkey=SimplifiedCase,
        source_attr="created",
    ),
    CSVColumn(
        column_header="Status", source_classkey=SimplifiedCase, source_attr="status"
    ),
    CSVColumn(
        column_header="Auditor", source_classkey=SimplifiedCase, source_attr="auditor"
    ),
    CSVColumn(
    ...
    CSVColumn(
        column_header="Sector", source_classkey=SimplifiedCase, source_attr="sector"
    ),
    CSVColumn(
    ...
    CSVColumn(
        column_header="QA status",
        source_classkey=SimplifiedCase,
        source_attr="qa_status",
    ),
    CSVColumn(
    ...
    CSVColumn(
        ...
        source_classkey=SimplifiedContact,
        source_attr="email",
    ),
]
