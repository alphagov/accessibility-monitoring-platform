...
class MockCase:
    ...
    id: int
    casestatus: MockCaseStatus = field(default_factory=MockCaseStatus)
...
MOCK_CASES: list[MockCase] = [
    MockCase(
        id=33,
        casestatus=MockCaseStatus(status="reviewing-changes"),
        twelve_week_correspondence_acknowledged_date=FIRST_DATE,
    ),
    MockCase(
        id=32,
        casestatus=MockCaseStatus(status="case-closed-sent-to-equalities-body"),
        sent_to_enforcement_body_sent_date=FIRST_DATE,
    ),
    MockCase(
        id=31,
        casestatus=MockCaseStatus(status="case-closed-waiting-to-be-sent"),
        case_close_complete_date=FIRST_DATE,
    ),
    MockCase(
        id=30,
        casestatus=MockCaseStatus(status="qa-in-progress"),
    ),
    MockCase(
        id=29,
    ...
    MockCase(
        id=25,
        casestatus=MockCaseStatus(status="in-correspondence-with-equalities-body"),
    ...
    MockCase(
        id=22,
        casestatus=MockCaseStatus(status="final-decision-due"),
        report_followup_week_12_due_date=SECOND_DATE,
    ),
    MockCase(
        id=21,
    ...
    MockCase(
        id=19,
        casestatus=MockCaseStatus(status="in-12-week-correspondence"),
    ...
    MockCase(
        id=16,
        casestatus=MockCaseStatus(status="in-probation-period"),
        next_action_due_date=SECOND_DATE,
    ),
    MockCase(
        id=15,
    ...
    MockCase(
        id=13,
        casestatus=MockCaseStatus(status="in-report-correspondence"),
        next_action_due_date=SECOND_DATE,
    ),
    MockCase(
        id=12,
    ...
    MockCase(
        id=10,
        casestatus=MockCaseStatus(status="report-ready-to-send"),
    ),
    MockCase(
        id=9,
        casestatus=MockCaseStatus(status="report-ready-to-send"),
    ...
    MockCase(
        id=8,
        casestatus=MockCaseStatus(status="report-in-progress"),
    ),
    MockCase(
        id=7,
        casestatus=MockCaseStatus(status="report-in-progress"),
    ...
    MockCase(
        id=6,
        casestatus=MockCaseStatus(status="test-in-progress"),
    ),
    MockCase(
        id=5,
        casestatus=MockCaseStatus(status="test-in-progress"),
    ...
    MockCase(
        id=4,
        casestatus=MockCaseStatus(status="unassigned-case"),
    ),
    MockCase(
        id=3,
        casestatus=MockCaseStatus(status="unassigned-case"),
...
EXPECTED_MOCK_CASES_BY_STATUS = {
    ...
    "in_report_correspondence": [
        ...
        MockCase(id=11, casestatus=MockCaseStatus(status="in-report-correspondence")),
    ],
