...
class AboutView(TemplateView):
    ...
    def user_view(self, context, user):
        ...
        sorted_cases = {
            "new_case": filter_by_status(user_entries, "new_case"),
            "test_in_progress": filter_by_status(user_entries, "test_in_progress"),
            "reports_in_progress": filter_by_status(user_entries, "report_in_progress"),
            "qa_cases": filter_by_status(qa_entries, "qa_cases"),
            "awaiting_response_to_report": filter_by_status(user_entries, "awaiting_response_to_report"),
            "twelve_week_review_due": filter_by_status(user_entries, "twelve_week_review_due"),
            "update_for_enforcement_bodies_due": filter_by_status(user_entries, "update_for_enforcement_bodies_due"),
            "recently_completed": filter_by_status(user_entries, "recently_completed"),
        }
    ...
    def macro_view(self, context, user):
        ...
        user_entries = Case.objects.filter(auditor=user).order_by("created")
        sorted_cases = {
            "unassigned_cases": filter_by_status(all_entries, "unassigned_cases"),
            "new_case": filter_by_status(all_entries, "new_case"),
            "test_in_progress": filter_by_status(all_entries, "test_in_progress"),
            "reports_in_progress": filter_by_status(all_entries, "report_in_progress"),
            "qa_cases": filter_by_status(all_entries, "qa_cases"),
            "unassigned_qa_cases": filter_by_status(all_entries, "unassigned_qa_cases"),
            "awaiting_response_to_report": filter_by_status(all_entries, "awaiting_response_to_report"),
            "twelve_week_review_due": filter_by_status(all_entries, "twelve_week_review_due"),
            "update_for_enforcement_bodies_due": filter_by_status(all_entries, "update_for_enforcement_bodies_due"),
            "recently_completed": filter_by_status(all_entries, "recently_completed"),
        }
        ...
        headers = {
            ...
            "unassigned_qa_cases": ["Date created", "Case", "Organisation", "QA auditor"],
            "awaiting_response_to_report": ["Days since being sent", "Case", "Organisation", "Auditor"],
            "twelve_week_review_due": ["Review due", "Case", "Organisation", "Auditor"],
            "update_for_enforcement_bodies_due": ["Review due", "Case", "Organisation", "Auditor"],
