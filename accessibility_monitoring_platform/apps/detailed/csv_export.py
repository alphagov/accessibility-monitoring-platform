...
DETAILED_EQUALITY_BODY_METADATA_COLUMNS_FOR_EXPORT: list[EqualityBodyCSVColumn] = [
    EqualityBodyCSVColumn(
        ...
        source_classkey=DetailedCase,
        source_attr="enforcement_body",
        required=True,
        edit_url_classkey=DetailedCase,
...
DETAILED_CASE_COLUMNS_FOR_EXPORT: list[CSVColumn] = [
    ...
    CSVColumn(
        column_header="Version", source_classkey=DetailedCase, source_attr="version"
    ),
    CSVColumn(
    ...
    CSVColumn(
        column_header="Status", source_classkey=DetailedCase, source_attr="status"
    ),
    CSVColumn(
        column_header="Domain name", source_classkey=DetailedCase, source_attr="domain"
    ),
    CSVColumn(
    ...
    CSVColumn(
        column_header="Sector", source_classkey=DetailedCase, source_attr="sector"
    ),
    CSVColumn(
        column_header="Sub-category",
        source_classkey=DetailedCase,
    ...
    CSVColumn(
        column_header="Contact name",
        source_classkey=DetailedContact,
        source_attr="name",
    ),
    CSVColumn(
