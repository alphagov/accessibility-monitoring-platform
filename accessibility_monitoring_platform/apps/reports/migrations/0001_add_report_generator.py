    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_type', models.CharField(choices=[('markdown', 'Markdown'), ('urls', 'Contains URL table'), ('issues', 'Contains Issues table'), ('html', 'HTML')], default='markdown', max_length=20)),
