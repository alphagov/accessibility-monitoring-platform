...
def test_case_status_deactivated(admin_client):
    ...
    assert (
        case.status.calculate_case_deactivated_status == CaseStatus.Status.DEACTIVATED
    )
...
def test_case_status_unassigned(admin_client):
    ...
    assert case.status.calculate_unnassigned_case_status == CaseStatus.Status.UNASSIGNED
...
def test_case_status_test_in_progress(admin_client):
    ...
    assert (
        case.status.calculate_test_in_progress_status
...
def test_case_status_report_in_progress(admin_client):
    ...
    assert (
        case.status.calculate_report_in_progress_status
...
def test_case_status_qa_in_progress(admin_client):
    ...
    assert (
        case.status.calculate_qa_in_progress_status == CaseStatus.Status.QA_IN_PROGRESS
    )
...
def test_case_status_report_ready_to_send(admin_client):
    ...
    assert (
        case.status.calculate_report_ready_to_send_status
...
def test_case_status_in_report_correspondence(admin_client):
    ...
    assert (
        case.status.calculate_in_report_correspondence_status
...
def test_case_status_when_no_psb_contact(admin_client):
    ...
    assert (
        case.status.calculate_final_decision_due_status
...
def test_case_status_in_probation_period(admin_client):
    ...
    assert (
        case.status.calculate_awaiting_12_week_deadline_status
...
def test_case_status_in_12_week_correspondence(admin_client):
    ...
    assert (
        case.status.calculate_in_12_week_correspondence_status
...
def test_case_status_skips_to_reviewing_changes_when_psb_respond_early(admin_client):
    ...
    assert (
        case.status.calculate_reviewing_changes_status
...
def test_case_status_case_closed_waiting_to_be_sent(admin_client):
    ...
    assert (
        case.status.calculate_case_closed_waiting_to_be_sent_status
...
def test_case_status_case_closed_sent_to_equality_bodies(admin_client):
    ...
    assert (
        case.status.calculate_case_closed_sent_to_enforcement_body_status
...
def test_case_status_in_correspondence_with_equalities_body(admin_client):
    ...
    assert (
        case.status.calculate_in_correspondence_with_enforcement_body_status
...
def test_case_status_equality_bodies_complete(admin_client):
    ...
    assert case.status.calculate_case_complete_status == CaseStatus.Status.COMPLETE
