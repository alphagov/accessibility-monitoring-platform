    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_type', models.CharField(choices=[('simplified', 'Simplified'), ('detailed', 'Detailed'), ('mobile', 'Mobile')], default='simplified', max_length=10)),
                ...
                ('psb_location', models.CharField(choices=[('england', 'England'), ('scotland', 'Scotland'), ('wales', 'Wales'), ('northern_ireland', 'Northern Ireland'), ('unknown', 'Unknown')], default='unknown', max_length=20)),
                ...
                ('accessibility_statement_state', models.CharField(choices=[('compliant', 'Compliant'), ('partially', 'Partially compliant'), ('not-compliant', 'Not compliant'), ('missing', 'Missing accessibility statement'), ('unknown', 'Not known')], default='unknown', max_length=200)),
                ...
                ('accessibility_statement_state_final', models.CharField(choices=[('compliant', 'Compliant'), ('partially', 'Partially compliant'), ('not-compliant', 'Not compliant'), ('missing', 'Missing accessibility statement'), ('unknown', 'Not known')], default='unknown', max_length=200)),
                ('accessibility_statement_notes_final', models.TextField(blank=True, default='')),
                ('is_website_compliant_final', models.CharField(choices=[('yes', 'Compliant'), ('partially', 'Partially compliant'), ('no', 'Not compliant'), ('unknown', 'Not known')], default='unknown', max_length=20)),
                ('compliance_decision_notes_final', models.TextField(blank=True, default='')),
                ('compliance_email_sent_date', models.DateField(blank=True, null=True)),
                ('case_completed', models.CharField(choices=[('escalated', 'The audit needs to be sent to the relevant equalities body'), ('no-action', 'The case requires no further action'), ('no-decision', 'Decision not reached')], default='no-decision', max_length=20)),
                ...
                ('escalation_state', models.CharField(choices=[('no-action', 'No further action is required and correspondence has closed regarding this issue'), ('ongoing', 'Correspondence ongoing'), ('not-started', 'Not started')], default='not-started', max_length=20)),
