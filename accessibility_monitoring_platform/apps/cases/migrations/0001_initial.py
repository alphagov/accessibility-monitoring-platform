# Generated by Django 3.2.4 on 2021-08-18 15:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case_completed', models.CharField(choices=[('no-action', 'The case requires no further action'), ('escalated', 'The audit needs to be sent to the relevant equalities body'), ('no-decision', 'Decision not reached')], default='no-decision', max_length=20)),
