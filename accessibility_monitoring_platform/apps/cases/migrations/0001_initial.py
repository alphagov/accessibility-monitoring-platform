    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sector', models.CharField(blank=True, default='Sector', max_length=200)),
                ...
                ('week_12_followup_email_sent_date', models.DateField(blank=True, null=True)),
                ('week_12_followup_email_acknowledgement_date', models.DateField(blank=True, null=True)),
                ...
                ('region', models.ManyToManyField(blank=True, null=True, to='common.Region')),
