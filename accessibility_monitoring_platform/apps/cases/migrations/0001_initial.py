    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delete_reason', models.CharField(choices=[('not-psb', 'Organisation is not a public sector body'), ('mistake', 'Case was opened by mistake'), ('duplicate', 'This case was a duplicate case'), ('other', 'Other')], default='not-psb', max_length=20)),
